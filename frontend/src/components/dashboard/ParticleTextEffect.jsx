...
const DEFAULT_WORDS = ["MENTOROID", "UPLOAD", "MATERIALS", "DOUBTS"]
...
    const fontSize = Math.max(24, Math.floor(Math.min(canvas.width, canvas.height) * 0.18))
...
  }
	...
	useEffect(() => {
		...
		const resize = () => {
			...
			// Reset particles on resize for a clean layout fit
